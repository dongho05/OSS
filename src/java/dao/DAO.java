...
//        System.out.println(list.get(1).getBrand());
//        List<Category> list = d.getAllCate();
//        List<Product> list1=d.getByIDBrand(1);
//        int[] arr={1,2};
//        List<Product> list3=d.checkBoxProduct(arr);
//        Product p = d.getProductByID("N1");
//        System.out.println(p.getName());
//        System.out.println(list3.get(0).getCate().getCate_name());
//for (Category category : list) {
//            System.out.println(category.getCate_name());
//        }
//        System.out.println(list1.get(5).getBrand().getBrand_name());
    }
}
