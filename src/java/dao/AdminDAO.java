...
//        Brand b = new Brand(3, "");
//        Product p = new Product("SE222", "nam", 5625435, "dfghgsg", "rfgrtrsfgfsdgsdfgs", s, 34, "", "", c, b);
//        ad.update(p);
//        Customer c= new Customer("abc", "nguyen", "van", "a", "user6", 052462134, "nguyenva@gmail.com", "123456", 0);
//        ad.getCustomer(c);
//        List<Order> list = ad.getOrder();
//        System.out.println(list.get(0).getCustomerId());
        String id = ad.getCustomerBuyMost();
        System.out.println(id);
//        String list =ad.getProductBuyMost();
...
//    public Brand getTopBrand() {
//        Brand b = null;
//        String sql = "select top 1 * from Brands order by brand_id desc";
//        try {
//            PreparedStatement st = connection.prepareStatement(sql);
//            ResultSet rs = st.executeQuery();
//            if (rs.next()) {
//                int a = rs.getInt("brand_id");
//                String c = rs.getString("brand_name");
//                b = new Brand(a, c);
//            }
//        } catch (Exception e) {
//        }
...
//    }
//
//    public Category getTopCate() {
//        Category c =null;
//        String sql = "select top 1 * from Categories order by cate_id desc";
//        try {
//            PreparedStatement st = connection.prepareStatement(sql);
//            ResultSet rs = st.executeQuery();
//            if (rs.next()) {
//                int a=rs.getInt("cate_id");
//                String b=rs.getString("cate_name");
//                c=new Category(a, b);
//            }
//        } catch (Exception e) {
//        }
