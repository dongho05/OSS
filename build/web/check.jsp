    ...
    <body>
        ...
        <header id="header" class="fixed-top">
            <div class="container d-flex align-items-center justify-content-between">
                ...
                <h1 class="logo"><a href="home.jsp">Stickey Shoes</a></h1>
...
<!--                        <li class="dropdown"><a href="#"><span>Menu</span> <i class="bi bi-chevron-down"></i></a>
                            <ul>
                                        ...
                                        <c:forEach items="${requestScope.brand}" var="b">
                                            <li><a class="${b.brand_id==id?"active":""}" href="tab?id=${b.brand_id}">${b.brand_name}</a></li>
                                        </c:forEach>
                                    </ul>
                            <ul>
                                
                                <li class="dropdown"><a href="#"><span>Adidas</span> <i class="bi bi-chevron-right"></i></a>
                                </li>
                                <li class="dropdown"><a href="#"><span>Nike</span> <i class="bi bi-chevron-right"></i></a>
                                </li>
                                <li class="dropdown"><a href="#"><span>Balenciaga</span> <i class="bi bi-chevron-right"></i></a>
                                </li>
                                <li class="dropdown"><a href="#"><span>Converse</span> <i class="bi bi-chevron-right"></i></a>
                                </li>
                                <li class="dropdown"><a href="#"><span>Vans</span> <i class="bi bi-chevron-right"></i></a>
                                </li>
                                <li class="dropdown"><a href="#"><span>New Balance</span> <i class="bi bi-chevron-right"></i></a>
                                </li>
                        ...
                        <li class="dropdown"><a href="#"><span>Menu</span> <i class="bi bi-chevron-down"></i></a>
                                    <ul>
                                        ...
                                        <c:forEach items="${requestScope.cate}" var="c">
                                            <li><a class="${c.cate_id==id?"active":""}" href="tab?id=${c.cate_id}">${c.cate_name}</a></li>
                                        </c:forEach>
                                    </ul>
                        </li>
...
<!--            <section id="portfolio" class="portfolio">
                        ...
                        <div class="col-12 col-md-6 col-lg-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text show_txt">${o.info}</p>
                                    <div class="row">
                                        <div class="col">
        ...
        <div >
            <c:forEach begin="${1}" end="${requestScope.num}"var="i">
                ...
                <div class="pagination" style="text-align: center;margin-left: auto;margin-right: auto;padding-bottom: 50px">
                    <ul style="list-style: none;padding-top: 20px ">
                    <li class="page-item"><a class="${i==page?"active":""}" href="tab?page=${i}&id=${id}">${i}</a></li>
                </ul>
            </div>
            </c:forEach>
        </div>
