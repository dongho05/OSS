                    ...
                    <ul>
                        ...
                        <li class="dropdown"><a href="#"><span>Brand</span> <i class="bi bi-chevron-down"></i></a>
                            <ul>
                                ...
                                <c:forEach items="${db.allBrand}" var="b">
                        ...
                        <li class="dropdown"><a href="#"><span>Menu</span> <i class="bi bi-chevron-down"></i></a>
                            <ul>
                                ...
                                <c:forEach items="${db.allCate}" var="c">
...
<!--                                            <div class="col">
                                                <input type="number"  name="number" width="20px" placeholder="Enter number of product" value="1" style="margin-bottom: 15px;border-radius: 10px"/>
